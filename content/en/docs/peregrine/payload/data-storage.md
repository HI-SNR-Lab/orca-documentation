...
2. If you're storing data on the MicroSD card, it's not possible to use [`overlayroot` to protect](/docs/pi-sd-setup/#using-overlayroot-to-protect-the-file-system) the file system from corruption.
