...
There are a lot of different methods below that describe how to use SSH to connect your laptop to the Raspberry Pi. First you will need direct control of the Pi.
